            ...
            <p className="text-gray-700 text-sm font-light mb-4">{product.description}</p>
              ...
              <span className="border border-gray-300 px-1 py-1" onClick={incQuantity}>
                <AiOutlinePlus />
							...
							<div className="mx-4">
                <button 
                  className="border-2 border-zinc-900 hover:bg-neutral-50 border-2 text-xs font-semibold py-2 px-4 tracking-wide mx-4"
                  onClick={() => onAdd(product, quantity)}>
                  AGREGAR
                </button>
                <button 
                  className="border-2 border-zinc-900 bg-zinc-900 hover:bg-zinc-800 text-white text-xs font-semibold py-2 px-4 tracking-wide">
                  COMPRAR
                </button>
              </div>
            </div>
